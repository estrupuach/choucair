  ...
  I want to automatice the create new user in Utest
    ...
    Scenario Outline: Search the link UTest
      ...
      Examples:
        ...
        | Camilo      |  Cadavid   |m5iliwto@mail.com| Manizales|  170002       |  Apple    | iPhone   |     iOS 2.0        | Prueba1155+ |  Prueba1155+     |Welcome to the world's largest community of freelance software testers!|
